...
이 작업에서는 생성된 Log Analytics 작업 영역에 Sentinel을 추가합니다.
...
1. Sentinel을 작업 영역에 추가하는 데 몇 분 정도 걸릴 수 있습니다.  추가되면 **Microsoft Sentinel | 새 기능 및 가이드** 페이지가 표시됩니다.  Microsoft Sentinel 무료 평가판이 활성화되었다는 알림을 받게 됩니다.  **확인**을 선택합니다.
...
| 역할 | 사용 권한 |
|---|---|
| 보안 분석가 | 데이터, 인시던트, 통합 문서 및 기타 Sentinel 리소스 보기 및 인시던트 할당/해제. |
| 보안 엔지니어 | 통합 문서 및 분석 규칙 만들기 및 편집  콘텐츠 허브에서 솔루션 설치 및 업데이트 |
...
Contoso 보안 운영 팀의 역할 요구 사항에 대한 역할 기반 액세스 모델을 성공적으로 만들었습니다.
